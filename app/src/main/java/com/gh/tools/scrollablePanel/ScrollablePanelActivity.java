package com.gh.tools.scrollablePanel;
...
import com.gh.utils.views.recyclerview.scrollablePanel.ScrollablePanel;
...
/**
 * @author: gh
 * @description: 可以横竖滑动的控件
 * @date: 2016/12/6 15:49.
 * @from: https://github.com/mylhyl/AndroidAcp
 */
public class ScrollablePanelActivity extends AppCompatActivity {
    ...
    /**
     * 启动ScrollablePanelActivity
     *
     * @param context context
     */
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, ScrollablePanelActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScrollablePanel scrollablePanel = (ScrollablePanel) findViewById(R.id.id_panel);
