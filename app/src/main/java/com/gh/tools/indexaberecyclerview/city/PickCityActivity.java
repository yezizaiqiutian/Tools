package com.gh.tools.indexaberecyclerview.city;
...
import com.gh.tools.indexaberecyclerview.ToastUtil;
import com.gh.utils.views.recyclerview.indexableRecyclerView.IndexableAdapter;
import com.gh.utils.views.recyclerview.indexableRecyclerView.IndexableLayout;
import com.gh.utils.views.recyclerview.indexableRecyclerView.SimpleHeaderAdapter;
...
//        indexableLayout.setFastCompare(true);
        ...
        adapter.setOnItemContentClickListener(new IndexableAdapter.OnItemContentClickListener<CityEntity>() {
            ...
            public void onItemClick(View v, int originalPosition, int currentPosition, CityEntity entity) {
                if (originalPosition >= 0) {
                    ToastUtil.showShort(PickCityActivity.this, "Content选中:" + entity.getName() + "  当前位置:" + currentPosition + "  原始所在数组位置:" + originalPosition);
                } else {
                    ToastUtil.showShort(PickCityActivity.this, "Content选中Header:" + entity.getName() + "  当前位置:" + currentPosition);
                }
            }
        });
        ...
        adapter.setOnItemTitleClickListener(new IndexableAdapter.OnItemTitleClickListener() {
            ...
            public void onItemClick(View v, int currentPosition, String indexTitle) {
                ToastUtil.showShort(PickCityActivity.this, "Title选中:" + indexTitle + "  当前位置:" + currentPosition);
            }
        });
