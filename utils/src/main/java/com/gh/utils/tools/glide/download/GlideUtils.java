package com.gh.utils.tools.glide.download;
...
import static com.gh.utils.tools.glide.download.FileUtils.fileIsExists;
...
public class GlideUtils {
    ...
    public static boolean haveCache(Context context, String fileUrl) {
        return fileIsExists(context.getExternalCacheDir() + Md5.getFileName(fileUrl));
    }
