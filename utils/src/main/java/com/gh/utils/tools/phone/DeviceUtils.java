...
import com.gh.utils.tools.data.DataUtils;
...
public class DeviceUtils {
    ...
    /**
     * 系统版本系
     * [0] KERNELVERSION-内核版本
     * [1] SYSTEMVERSION-系统版本
     * [2] MODEL-手机型号
     * [3] FIRMWAREVERSION-固件版本
     * [4] BRAND-品牌
     */
    public enum Type {
        KERNELVERSION, SYSTEMVERSION, MODEL, FIRMWAREVERSION, BRAND
    }
     ...
     * @return
     */
    public static String getDeviceInfo(Type type) {
        String info = null;
        switch (type) {
            //内核版本
            case KERNELVERSION:
                ...
                try {
                    ...
                    info = arrayOfString[2];//KernelVersion
        ...
        try {
            ...
            while ((str2 = localBufferedReader.readLine()) != null) {
                if (str2.indexOf("MemTotal:") >= 0) {
                    return DataUtils.getIntFromString(str2);
                }
            }
        } catch (IOException e) {
        }
