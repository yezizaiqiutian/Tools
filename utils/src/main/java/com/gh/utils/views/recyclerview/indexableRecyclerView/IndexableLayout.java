...
import com.gh.utils.views.recyclerview.indexableRecyclerView.database.DataObserver;
import com.gh.utils.views.recyclerview.indexableRecyclerView.database.HeaderFooterDataObserver;
...
public class IndexableLayout extends FrameLayout {
    ...
    private void initMDOverlay(int color) {
        ...
        mMDOverlay.setBackgroundResource(R.mipmap.indexable_bg_md_overlay);
        ViewCompat.setBackgroundTintList(mMDOverlay, ColorStateList.valueOf(color));
